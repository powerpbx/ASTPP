...
-- ----------------------------------18-05-22
INSERT INTO `system` (`id`, `name`, `display_name`, `value`, `field_type`, `comment`, `timestamp`, `reseller_id`, `is_display`, `group_title`, `sub_group`, `field_rules`) VALUES (NULL, 'call_max_cost', 'Call Max Cost', '0', 'default_system_input', 'Set maximum cost (per minute) for call (0 = disabled)', '0000-00-00 00:00:00.000000', '0', '0', 'calls', 'General', '');
